...
with placeholder.container():
    ...
    if "load_state_8" and "Q8" and "Q8_ans" not in st.session_state:
    ...
    image, text, ask, select, answer = st.session_state['scam_operation'].return_values(question_no[7])
    ...
    if submit_answer or st.session_state.load_state_8:
        ...
        if submit_qns:
            st.session_state.Q8 = "scam" + " " + str(question_number)
