...
with placeholder.container():
    ...
    if "load_state_9" and "Q9" and "Q9_ans" not in st.session_state:
        st.session_state["load_state_9"] = False
        st.session_state["Q9"] = []
        st.session_state["Q9_ans"] = []
    ...
    image, text, ask, select, answer = st.session_state['scam_operation'].return_values(question_no[8])
    ...
    if submit_answer or st.session_state.load_state_9:
        ...
        if submit_qns:
            st.session_state.Q9 = "scam" + " " + str(question_number)
