...
with placeholder.container():
    ...
    image, text, ask, select, answer = st.session_state['scam_operation'].return_values(question_no[9])
    ...
    if submit_answer or st.session_state.load_state_10:
        ...
        if submit_qns:
            st.session_state.Q10 = "scam" + " " + str(question_number)
            ...
            insert_quiz_result(key, date, st.session_state.name, st.session_state.scores,
                               st.session_state.Q1, st.session_state.Q1_ans, st.session_state.Q2,
                               st.session_state.Q2_ans,
                               st.session_state.Q3, st.session_state.Q3_ans, st.session_state.Q4,
                               st.session_state.Q4_ans,
                               st.session_state.Q5, st.session_state.Q5_ans, st.session_state.Q6,
                               st.session_state.Q6_ans,
                               st.session_state.Q7, st.session_state.Q7_ans, st.session_state.Q8,
                               st.session_state.Q8_ans,
                               st.session_state.Q9, st.session_state.Q9_ans, st.session_state.Q10,
                               st.session_state.Q10_ans)
