...
with placeholder.container():
    ...
    image, text, ask, select, answer = st.session_state['scam_operation'].return_values(question_no[5])
    ...
    if submit_answer or st.session_state.load_state_6:
        ...
        if submit_qns:
            st.session_state.Q6 = "scam" + " " + str(question_number)
            st.session_state.Q6_ans = correctness
            placeholder.empty()
